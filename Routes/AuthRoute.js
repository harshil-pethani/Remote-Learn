...
import { login, register, checkAdmin, updateAdmin, updateAdminPassword, logout, forgotPassword, resetTokenVerify, resetPassword, getAllAdmins, updateAdminStatus } from '../Controllers/AuthController.js';
